...
<form class="layui-form" style="font-size:3px" action="" id="app">
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" readonly="readonly" v-model="detail.activityCode" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" style="width:190px" name="date" id="test1" autocomplete="off" class="layui-input"
                       v-model="detail.salesStartTime">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label layui-required">销售结束时间</label>
            <div class="layui-input-block">
                <input type="text" style="width:190px" name="date" id="test2" autocomplete="off" class="layui-input"
                       v-model="detail.salesEndTime">
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="username" @input="amountChange" v-model="detail.amount" lay-verify="required"
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <input type="text" name="number" lay-verify="required|number" autocomplete="off" class="layui-input"
                   style="width:90%" v-model="detail.introduction" @input="textChange">
        </div>
    </div>
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label layui-required">活动描述</label>
        <div class="layui-input-block">
            <textarea placeholder="请输入内容" class="layui-textarea" v-model="detail.description"
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="date" id="test3" lay-verify="date" autocomplete="off" class="layui-input"
                       v-model="detail.usageStartTime">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label layui-required">核销结束时间</label>
            <div class="layui-input-inline">
                <input type="text" name="date" id="test4" lay-verify="date" autocomplete="off" class="layui-input"
                       v-model="detail.usageEndTime">
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="contractAmount" lay-verify="contractAmount" autocomplete="off"
                       class="layui-input" v-model="detail.contractAmount" @input="valueChange">
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="identity" lay-verify="identity" placeholder="" autocomplete="off"
                   class="layui-input" style="width: 90%" v-model="detail.sharedActivity">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="number" lay-verify="required|number" autocomplete="off" class="layui-input"
                       v-model="detail.packageOriginalPrice" @input="packageOriginalPriceChange">
            </div>
        </div>
        <div class="layui-inline">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="number" lay-verify="required|number" autocomplete="off" class="layui-input"
                       v-model="detail.sellingPrice" @input="sellingPriceChange">
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="number" lay-verify="required|number" autocomplete="off" class="layui-input"
                       v-model="detail.billPrice" @input="billPricePriceChange">
            </div>
        </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="number" lay-verify="required|number" autocomplete="off" class="layui-input"
                       v-model="detail.handlingFee" @input="handlingFeeChange">
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="number" lay-verify="required|number" autocomplete="off" class="layui-input"
                       v-model="detail.taxRate" @input="taxRateChange">
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <div class="layui-input-block">
            <button type="button" class="layui-btn layui-btn-normal" id="LAY-component-form-setval" @click="edit()">
                修改活动
            </button>
    ...
    <div id="dept_main" style="margin-right: 2%;">
                <span>
                    <input type="text" id="search"
                           style="width: 70%;border: 1px solid gray; border-radius: 4px; outline: none;"/>
                </span>
        <div id="dept_tree">
        </div>
