...
<script type="text/javascript" src="${ctx}/static/vue/vue-1.0.28.min.js"></script>
<script type="text/javascript" src="${ctx}/static/vue/vue-resource-1.0.3.min.js"></script>
<script>
    var app = new Vue({
        el: '#app',
        data: {
        ...
        methods:{
            ...
            toModify:function(index){
                this.modifyKey = this.querydata[index].innerBusinessCatetoryType;
                this.modifyValue = this.querydata[index].stationWindowType;
