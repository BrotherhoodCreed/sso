...
public enum BizErrorEnum implements Serializable {
    ...
    OBJECT_HAS_EXISTED(10031, "OBJECT_HAS_EXISTED", "数据已存在"),
    DATABASE_ERROR(10032, "DATABASE_ERROR", "数据库操作错误"),
    ...
    private BizErrorEnum(int code, String name, String desc) {
        this.code = code;
        this.name = name;
        this.desc = desc;
    }
